...
#elif defined (Prepaid_SDK_OLD2)
    PrepaidViewControllerOld2 *viewController = [[PrepaidViewControllerOld2 alloc] initWithNibName:@"PrepaidViewControllerOld2" bundle:nil];
#endif
